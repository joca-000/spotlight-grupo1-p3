...
public class Main {
    ...
    private void exibirCadastro() {
        ...
        System.out.println("1 - alta_administracao");
        System.out.println("2 - backstage");
        System.out.println("3 - ator");
        System.out.println("4 - adm_geral");
        System.out.println("5 - adm_criativo");
        int tipoOpcao = lerInteiroValido("Digite o número correspondente: ");

        String tipo;
        switch (tipoOpcao) {
            case 1:
                tipo = "alta_administracao";
                break;
            case 2:
                tipo = "backstage";
                break;
            ...
            case 5:
                ...
                break;
            default:
                System.out.println("Opção inválida. Tipo definido como 'ator' por padrão.");
                tipo = "ator";
                pausar();
        }
